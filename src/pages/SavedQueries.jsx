...
const AVAILABLE_COLUMNS = [
  ...
  { key: 'voted_at', label: 'Ώρα Ψήφου', type: 'text' },
  ...
  { key: 'monadikos_kanali', label: 'Μοναδικός Καναλιού', type: 'text' },
  { key: 'direction', label: 'Κατεύθυνση', type: 'text' },
  { key: 'phone', label: 'Τηλέφωνο', type: 'text' },
  { key: 'details', label: 'Παρατηρήσεις', type: 'text' },
  { key: 'father_n', label: 'Αρχικό Πατέρα', type: 'text' },
  { key: 'father_name', label: 'Όνομα Πατέρα', type: 'text' },
  { key: 'ElectoralDistrict', label: 'Εκλογική Περιφέρεια', type: 'text' },
  { key: 'ElectoralTown', label: 'Εκλογικός Δήμος', type: 'text' },
  { key: 'RelatedMember', label: 'Σχετικό Μέλος', type: 'text' },
  { key: 'X', label: 'X', type: 'text' },
  { key: 'F26_1', label: 'Φ26_1', type: 'text' },
  { key: 'F25', label: 'Φ25', type: 'text' },
  { key: 'T24', label: 'T24', type: 'text' },
  { key: 'F24', label: 'Φ24', type: 'text' },
  { key: 'F23', label: 'Φ23', type: 'text' },
  { key: 'T22', label: 'T22', type: 'text' },
];
